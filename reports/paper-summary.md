...
![[Combinatorical Optimization Project Report-1.png]]

**تحلیل نتایج:**

۱. **عملکرد برتر فرمول‌بندی‌های نمره برش**: فرمول‌بندی‌های مبتنی بر نمره برش (SO-NW-CUT با ۸۱ ثانیه و SO-NW-BIN-CUT با ۱۰۷ ثانیه) عملکرد بسیار بهتری نسبت به فرمول‌بندی کلاسیک Baiou-Balinski (SO-BB با ۱۱۳۹ ثانیه) دارند. اگرچه SO-NW-CUT تعداد متغیرهای بیشتری دارد، اما ساختار قیدهای آن (با تعداد درایه‌های غیرصفر بسیار کمتر) باعث کاهش چشمگیر زمان حل می‌شود.

۲. **مقایسه نسخه پیوسته و دودویی نمره برش**: در مدل پایه، نسخه پیوسته (SO-NW-CUT با ۸۱ ثانیه) اندکی بهتر از نسخه دودویی (SO-NW-BIN-CUT با ۱۰۷ ثانیه) عمل می‌کند. با این حال، در بخش‌های بعدی مقاله که رتبه‌های مساوی و سهمیه‌های مشترک اضافه می‌شوند، نسخه دودویی برتری چشمگیری پیدا خواهد کرد.

۳. **عملکرد ضعیف MSMR-EF**: فرمول‌بندی بدون حسادت مستقیم (MSMR-EF) به دلیل تعداد بسیار زیاد درایه‌های غیرصفر (۸,۶۶۷,۴۰۳) قادر به پایان‌یافتن در زمان معقول نبود و از ادامه آزمایش‌ها برای مدل‌های پیچیده‌تر حذف شد.

۴. **تاثیر تابع هدف**: در بین فرمول‌بندی‌های نمره برش، استفاده از تابع هدف (۴) در SO-NW-CUT همراه با قیدهای صریح عدم اسراف، بهترین عملکرد را داشت و از روش‌های مبتنی بر بیشینه‌سازی وزنی (MSMR) یا کمینه‌سازی ساده نمرات برش (MIN) کارآمدتر بود.
