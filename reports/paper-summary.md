...
2. **تأثیر قیدهای عدم اسراف مستقیم:** فرمول‌بندی‌های SO-H-NW-CUT و SO-H-NW-BIN-CUT که مستقیماً شرط عدم اسراف را اعمال می‌کنند، در مقایسه با فرمول‌بندی‌های مبتنی بر توابع هدف (MIN و MSMR) عملکرد بهتری دارند. این نشان می‌دهد که اعمال مستقیم قیدها به جای اتکا به تابع هدف، در این مسئله کارآمدتر است.
